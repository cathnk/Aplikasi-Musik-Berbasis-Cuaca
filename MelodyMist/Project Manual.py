...
class project:
    ...
    def login(self):
        ...
        self.cuaca = StringVar()
        self.entry5 = Entry(self.label_main_page, justify=LEFT, text=self.cuaca, border=0, bg="white", font=("Poppins", 25, 'bold'), fg="grey")
        self.entry5.place(relwidth=0.365, relheight=0.125, relx=0.315, rely=0.59)
        self.entry5.insert(0, "Cuaca")
    ...
    def set_cuaca(self):
        ...
        self.weather.append(input_cuaca)
        cuaca = self.weather[0]
        self.cuacanow = cuaca
    ...
    def home(self):
        ...
        self.tanggal = current_datetime.strftime("%d %B %Y")
        self.waktu = current_datetime.strftime("%H:%M")

        self.lokasi = Label(self.frame_cuaca, text="Surabaya", bg="#fcffe0", fg="black", font=("Poppins", 50), anchor="w")
        self.lokasi.place(relwidth=0.5, relheight=0.52, relx=0.02, rely=0.09)
        self.texttanggal = Label(self.frame_cuaca, text=self.tanggal, bg="#fcffe0", fg="black", font=("Open Sans", 15), anchor="center")
        self.texttanggal.place(relwidth=0.5, relheight=0.2, relx=0.6, rely=0.625)
        self.textwaktu = Label(self.frame_cuaca, text=self.waktu, bg="#fcffe0", fg="black", font=("Open Sans", 50), anchor="center")
        self.textwaktu.place(relwidth=0.3, relheight=0.4, relx=0.7, rely=0.2)
        self.textcuaca = Label(self.frame_cuaca, text=f"Cuaca saat ini : {self.cuacanow}", bg="#fcffe0", fg="black", font=("Open Sans", 20), anchor="w")
        self.textcuaca.place(relwidth=0.6, relheight=0.25, relx=0.03, rely=0.64)
        ...
        if not self.peringatancuaca:
            weather_condition = self.cuacanow
    ...
    def profil(self):
        ...
        self.datausername.place(relwidth=0.25, relheight=0.1, relx=0.26, rely=0.21)
        self.dataemail = Label(self.label_isi, text=f"{self.entry3.get()}", bg="white", fg="grey", font=("Open Sans", 22),anchor="w")
        self.dataemail.place(relwidth=0.25, relheight=0.1, relx=0.26, rely=0.36)
        self.datapassword = Label(self.label_isi, text=f"{self.entry4.get()}", bg="white", fg="grey", font=("Open Sans", 22),anchor="w")
        self.datapassword.place(relwidth=0.25, relheight=0.1, relx=0.26, rely=0.51)
        self.datalokasi = Label(self.label_isi, text="Surabaya", bg="white", fg="grey", font=("Open Sans", 22),anchor="w")
        self.datalokasi.place(relwidth=0.25, relheight=0.1, relx=0.26, rely=0.66)
    ...
    def weatherplaylist(self):
        ...
        if self.cuacanow in ['Hujan', 'Gerimis', 'Angin kencang', 'Kabut', 'Asap', 'Berawan', 'Abu', 'Badai petir', 'Angin kencang']:
    ...
    def playlistforyou(self):
        ...
        self.imgweather = ImageTk.PhotoImage(file="C:/Project UAS TERBARU/Playlistforyou.png")
        self.label_weather = Label(self.label_isi, image=self.imgweather, bg="#132a46")
        self.label_weather.place(relwidth=1, relheight=0.2, relx=0.015, rely=0.01)
